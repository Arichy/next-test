...
export default function Pagination({ totalPages, classNames }: { totalPages: number; classNames?: string }) {
  ...
  console.log('render Pagination', pathname, currentPage, allPages);

  return (
    <div className={clsx('inline-flex', classNames)}>
